...
def generate_gfg_problems_files(data, base_folder, base_name):
    ...
    for item in data:
        ...
        gfg_url = f"https://www.geeksforgeeks.org/problems/{slug}/1"
        ...
        with open(filepath, "w", encoding="utf-8") as f:
            ...
            f.write(f"[![GeeksforGeeks](<https://img.shields.io/badge/GeeksforGeeks-Problem-0F9D58?style=for-the-badge&logo=geeksforgeeks&logoColor=white>)]({gfg_url})\n\n")
            f.write(f"</div>\n\n")
            f.write("---\n\n")
            ...
            f.write(f"| **Problem Link** | [Open in GeeksforGeeks]({gfg_url}) |\n")
